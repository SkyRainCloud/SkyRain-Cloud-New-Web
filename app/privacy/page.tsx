        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-gray max-w-none">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">1. Data Collected</h2>

              <h3 className="text-xl font-semibold text-gray-900 mb-3">a. Personal Information You Provide</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">c. Cookies and Tracking Technologies</h3>
              <ul className="text-gray-600 mb-6 ml-6 list-disc space-y-2">
                <li>Maintain sessions</li>
                <li>Remember user preferences</li>
                <li>Enhance website performance</li>
              </ul>
              <p className="text-gray-600 mb-6">Cookies are stored on your device and may be disabled via browser settings, although this may affect functionality.</p>

              <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Use of the Data</h2>
              <ul className="text-gray-600 mb-6 ml-6 list-disc space-y-2">
              ...
              <p className="text-gray-600 mb-6">We do not sell your personal data to third parties. We only share it under limited, legitimate circumstances.</p>

              <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Sharing of Data</h2>
              <ul className="text-gray-600 mb-6 ml-6 list-disc space-y-2">
              ...
              <p className="text-gray-600 mb-6">While we take strong precautions, no system is 100% secure. We are not liable for breaches outside our control.</p>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">7. About Children</h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Legal Complaints</h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">10. Data Deletion</h2>
              <p className="text-gray-600 mb-6">
