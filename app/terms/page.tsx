        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <p>
                Contact us via our official Discord: <a href="https://dsc.gg/skyrain-cloud" target="_blank" rel="noopener noreferrer">https://dsc.gg/skyrain-cloud</a>
              </p>
            </div>
